...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if (isset($_GET['submitcode'])) {
        ...
        if($concatenated == $_SESSION["token"]){ # $_SESSION["token"]
...
function sendToken($email){
    ...
    $_SESSION["resetpwEmail"] = $email; # we only set it as a session variable, once we have verified that input email actually exists in our db 
